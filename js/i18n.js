...
(function () {
  var STRINGS = {
    ro: {
      ...
      "home.hero.apps.label": "Aplicația mobilă — în construcție",
    ...
    en: {
      ...
      "home.hero.apps.label": "Mobile app — coming soon",
